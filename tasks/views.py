...
def admin_panel(request):
    # Estadísticas para mostrar al admin
    total_users = User.objects.count()
    total_tasks = Task.objects.count()
    completed_tasks = Task.objects.filter(datecompleted__isnull=False).count()
    pending_tasks = Task.objects.filter(datecompleted__isnull=True).count()
